...
struct ButtonView: View {
    ...
    internal init(title: String, titleColor: Color = .black, width: CGFloat = Metrics.witdh, height: CGFloat = Metrics.height, color: Color = .clear, icon: String, clickTap: @escaping () -> Void) {
        self.title = title
